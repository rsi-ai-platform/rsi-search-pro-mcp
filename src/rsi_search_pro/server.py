...
_INSTRUCTIONS = (
    ...
    "aggregates the tool catalogs of FOUR upstream MCPs into one place and "
    ...
    "    Haiku vision. Last-resort for JS-rendered pages.\n"
    ...
    "  4. excel_fetch_structured            → spreadsheets (GST, MoSPI)\n"
